...
class User_settings(db.Model):
    ...
    name_font_color = db.Column(db.String(100))
    abv_font_color = db.Column(db.String(100))
    ibu_font_color = db.Column(db.String(100))
    brewery_font_color = db.Column(db.String(100))
