...
def settings():
    ...
    form = SettingsForm(request.form,
        ...
        screenNumberSettings = settings['screenNumberSettings'],
    ...
    form.screenNumberSettings.choices = [ (number['id'], number['number']) for number in screenNumSettings ]
    ...
    if form.validate_on_submit():
        ...
        userSettings['screen_number_settings'] = form.screenNumberSettings.data
        ...
        settingsCandidate = User_settings.query.filter_by(screen_number_settings=userSettings['screen_number_settings'], venue_db_id=current_user.id).first()
